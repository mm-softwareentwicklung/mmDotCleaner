<p align="center">
  <img src="images/icon-512.png" width="128" height="128" alt="mmDotCleaner-Icon">
</p>

<h1 align="center">mmDotCleaner</h1>

<p align="center">
  Fegt <code>.DS_Store</code>- und <code>._</code>-Dateien aus jedem Ordner – mit einem Klick in der Symbolleiste des Finders.<br>
...
<picture>
  ...
  <img src="images/de/hero-light.png" alt="mmDotCleaner: Fortschritt in der Menüleiste und Einstellungen">
</picture>
...
<p align="center">
  <picture>
    ...
    <img src="images/de/progress-light.png" width="49%" alt="Blase in der Menüleiste während der Bereinigung">
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/de/result-dark.png">
    <img src="images/de/result-light.png" width="49%" alt="Ergebnis der Bereinigung">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="images/de/settings-files-light.png" width="49%" alt="Einstellungen – Dateien">
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/de/settings-history-dark.png">
    <img src="images/de/settings-history-light.png" width="49%" alt="Einstellungen – Verlauf">
  </picture>
</p>
<p align="center">
  <picture>
...
<picture>
  ...
  <img src="images/en/hero-light.png" alt="mmDotCleaner: progress in the menu bar and settings">
</picture>
...
<p align="center">
  <picture>
    ...
    <img src="images/en/progress-light.png" width="49%" alt="Bubble in the menu bar while cleaning">
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/en/result-dark.png">
    <img src="images/en/result-light.png" width="49%" alt="Result of the cleanup">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="images/en/settings-files-light.png" width="49%" alt="Settings – Files">
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/en/settings-history-dark.png">
    <img src="images/en/settings-history-light.png" width="49%" alt="Settings – History">
  </picture>
</p>
<p align="center">
  <picture>
